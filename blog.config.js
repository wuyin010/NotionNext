...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '流风回雪', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '若见诸相非相 即见如来', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zone.lfhx.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,流风回雪', // 网站关键词 英文逗号隔开
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/shizuku/shizuku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_METING: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING || true, // 是否要开启 MetingJS，从平台获取歌单。会覆盖自定义的 MUSIC_PLAYER_AUDIO_LIST，更多配置信息：https://github.com/metowolf/MetiingJS
  MUSIC_PLAYER_METING_SERVER:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'netease', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || 893126993, // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.lfhx.me', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-1Y00Q4PCP5', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'or43ve7nao', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
